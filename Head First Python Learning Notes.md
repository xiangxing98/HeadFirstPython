...
## 第二章 分享代码：函数模块 Share code: Function modules
...
## 第四章 持久化：将数据存成文件 Persistence: Saves data to a file
...
## 第九章 管理数据：处理输入 Manage data: Process input
...
### 1. 使用专业的IDE Use professional IDE
